"""
Kubernetes Kubelet Checks Service Logic
...
class KubernetesChecksKubelet(KubernetesServiceBase, DynamicCheckLoader):
    ...
    def _load_checks_dynamically(self):
        ...
        self.checks = self.load_checks_dynamically("kubelet")
