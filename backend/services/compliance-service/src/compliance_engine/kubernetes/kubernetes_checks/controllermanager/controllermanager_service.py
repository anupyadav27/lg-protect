"""
Kubernetes Controller Manager Checks Service Logic
...
class KubernetesChecksControllerManager(KubernetesServiceBase, DynamicCheckLoader):
    ...
    def _load_checks_dynamically(self):
        ...
        self.checks = self.load_checks_dynamically("controllermanager")
