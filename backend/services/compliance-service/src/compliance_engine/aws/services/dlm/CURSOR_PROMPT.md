...
- I'm working on the **dlm** service

**Current Service Details:**
- **Service Name:** dlm
- **Service File:** dlm_service.py
- **Check Files:** 
...
- Read and analyze the current dlm_service.py file
- Read and analyze all check files in the dlm directory
...
- Convert dlm_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..dlm_service import DlmService
