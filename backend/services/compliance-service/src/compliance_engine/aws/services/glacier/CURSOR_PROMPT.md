# Service Conversion Prompt - GLACIER
...
- I'm working on the **glacier** service

**Current Service Details:**
- **Service Name:** glacier
- **Service File:** glacier_service.py
- **Check Files:** 
...
- Read and analyze the current glacier_service.py file
- Read and analyze all check files in the glacier directory
...
- Convert glacier_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..glacier_service import GlacierService
