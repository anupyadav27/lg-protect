...
- I'm working on the **fms** service

**Current Service Details:**
- **Service Name:** fms
- **Service File:** fms_service.py
- **Check Files:** 
...
- Read and analyze the current fms_service.py file
- Read and analyze all check files in the fms directory
...
- Convert fms_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..fms_service import FmsService
