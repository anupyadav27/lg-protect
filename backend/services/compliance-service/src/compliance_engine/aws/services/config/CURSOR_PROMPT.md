# Service Conversion Prompt - CONFIG
...
- I'm working on the **config** service

**Current Service Details:**
- **Service Name:** config
- **Service File:** config_service.py
- **Check Files:** 
...
- Read and analyze the current config_service.py file
- Read and analyze all check files in the config directory
...
- Convert config_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..config_service import ConfigService
