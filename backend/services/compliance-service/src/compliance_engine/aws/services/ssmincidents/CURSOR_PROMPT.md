# Service Conversion Prompt - SSMINCIDENTS
...
- I'm working on the **ssmincidents** service

**Current Service Details:**
- **Service Name:** ssmincidents
- **Service File:** ssmincidents_service.py
- **Check Files:** 
...
- Read and analyze the current ssmincidents_service.py file
- Read and analyze all check files in the ssmincidents directory
...
- Convert ssmincidents_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..ssmincidents_service import SsmincidentsService
