# Service Conversion Prompt - STORAGEGATEWAY
...
- I'm working on the **storagegateway** service

**Current Service Details:**
- **Service Name:** storagegateway
- **Service File:** storagegateway_service.py
- **Check Files:** 
...
- Read and analyze the current storagegateway_service.py file
- Read and analyze all check files in the storagegateway directory
...
- Convert storagegateway_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..storagegateway_service import StoragegatewayService
