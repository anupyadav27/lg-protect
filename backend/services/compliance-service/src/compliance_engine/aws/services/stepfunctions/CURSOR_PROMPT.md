# Service Conversion Prompt - STEPFUNCTIONS
...
- I'm working on the **stepfunctions** service

**Current Service Details:**
- **Service Name:** stepfunctions
- **Service File:** stepfunctions_service.py
- **Check Files:** 
...
- Read and analyze the current stepfunctions_service.py file
- Read and analyze all check files in the stepfunctions directory
...
- Convert stepfunctions_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..stepfunctions_service import StepfunctionsService
