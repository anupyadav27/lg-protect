# Service Conversion Prompt - SERVICECATALOG
...
- I'm working on the **servicecatalog** service

**Current Service Details:**
- **Service Name:** servicecatalog
- **Service File:** servicecatalog_service.py
- **Check Files:** 
...
- Read and analyze the current servicecatalog_service.py file
- Read and analyze all check files in the servicecatalog directory
...
- Convert servicecatalog_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..servicecatalog_service import ServicecatalogService
