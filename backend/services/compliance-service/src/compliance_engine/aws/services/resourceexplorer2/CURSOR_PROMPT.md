# Service Conversion Prompt - RESOURCEEXPLORER2
...
- I'm working on the **resourceexplorer2** service

**Current Service Details:**
- **Service Name:** resourceexplorer2
- **Service File:** resourceexplorer2_service.py
- **Check Files:** 
...
- Read and analyze the current resourceexplorer2_service.py file
- Read and analyze all check files in the resourceexplorer2 directory
...
- Convert resourceexplorer2_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..resourceexplorer2_service import Resourceexplorer2Service
