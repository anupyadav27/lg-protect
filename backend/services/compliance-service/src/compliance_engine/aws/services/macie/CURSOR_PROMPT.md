# Service Conversion Prompt - MACIE
...
- I'm working on the **macie** service

**Current Service Details:**
- **Service Name:** macie
- **Service File:** macie_service.py
- **Check Files:** 
...
- Read and analyze the current macie_service.py file
- Read and analyze all check files in the macie directory
...
- Convert macie_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..macie_service import MacieService
