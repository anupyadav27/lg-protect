...
- I'm working on the **ssm** service

**Current Service Details:**
- **Service Name:** ssm
- **Service File:** ssm_service.py
- **Check Files:** 
...
- Read and analyze the current ssm_service.py file
- Read and analyze all check files in the ssm directory
...
- Convert ssm_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..ssm_service import SsmService
