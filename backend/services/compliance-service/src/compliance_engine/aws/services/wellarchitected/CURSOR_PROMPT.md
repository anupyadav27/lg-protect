# Service Conversion Prompt - WELLARCHITECTED
...
- I'm working on the **wellarchitected** service

**Current Service Details:**
- **Service Name:** wellarchitected
- **Service File:** wellarchitected_service.py
- **Check Files:** 
...
- Read and analyze the current wellarchitected_service.py file
- Read and analyze all check files in the wellarchitected directory
...
- Convert wellarchitected_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..wellarchitected_service import WellarchitectedService
