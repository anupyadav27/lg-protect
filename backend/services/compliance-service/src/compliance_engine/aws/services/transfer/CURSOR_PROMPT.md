# Service Conversion Prompt - TRANSFER
...
- I'm working on the **transfer** service

**Current Service Details:**
- **Service Name:** transfer
- **Service File:** transfer_service.py
- **Check Files:** 
...
- Read and analyze the current transfer_service.py file
- Read and analyze all check files in the transfer directory
...
- Convert transfer_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..transfer_service import TransferService
