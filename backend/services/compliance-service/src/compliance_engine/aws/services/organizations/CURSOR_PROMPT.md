# Service Conversion Prompt - ORGANIZATIONS
...
- I'm working on the **organizations** service

**Current Service Details:**
- **Service Name:** organizations
- **Service File:** organizations_service.py
- **Check Files:** 
...
- Read and analyze the current organizations_service.py file
- Read and analyze all check files in the organizations directory
...
- Convert organizations_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..organizations_service import OrganizationsService
