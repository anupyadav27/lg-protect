...
- I'm working on the **sns** service

**Current Service Details:**
- **Service Name:** sns
- **Service File:** sns_service.py
- **Check Files:** 
...
- Read and analyze the current sns_service.py file
- Read and analyze all check files in the sns directory
...
- Convert sns_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..sns_service import SnsService
