# Service Conversion Prompt - DATASYNC
...
- I'm working on the **datasync** service

**Current Service Details:**
- **Service Name:** datasync
- **Service File:** datasync_service.py
- **Check Files:** 
...
- Read and analyze the current datasync_service.py file
- Read and analyze all check files in the datasync directory
...
- Convert datasync_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..datasync_service import DatasyncService
