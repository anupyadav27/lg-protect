...
- I'm working on the **drs** service

**Current Service Details:**
- **Service Name:** drs
- **Service File:** drs_service.py
- **Check Files:** 
  - drs_job_exist
...
- Read and analyze the current drs_service.py file
- Read and analyze all check files in the drs directory
...
- Convert drs_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..drs_service import DrsService
