# Service Conversion Prompt - EVENTBRIDGE
...
- I'm working on the **eventbridge** service

**Current Service Details:**
- **Service Name:** eventbridge
- **Service File:** eventbridge_service.py
- **Check Files:** 
...
- Read and analyze the current eventbridge_service.py file
- Read and analyze all check files in the eventbridge directory
...
- Convert eventbridge_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..eventbridge_service import EventbridgeService
