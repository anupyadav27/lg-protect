# Service Conversion Prompt - SECRETSMANAGER
...
- I'm working on the **secretsmanager** service

**Current Service Details:**
- **Service Name:** secretsmanager
- **Service File:** secretsmanager_service.py
- **Check Files:** 
...
- Read and analyze the current secretsmanager_service.py file
- Read and analyze all check files in the secretsmanager directory
...
- Convert secretsmanager_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..secretsmanager_service import SecretsmanagerService
