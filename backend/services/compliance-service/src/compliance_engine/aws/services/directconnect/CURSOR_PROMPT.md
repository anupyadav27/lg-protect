# Service Conversion Prompt - DIRECTCONNECT
...
- I'm working on the **directconnect** service

**Current Service Details:**
- **Service Name:** directconnect
- **Service File:** directconnect_service.py
- **Check Files:** 
...
- Read and analyze the current directconnect_service.py file
- Read and analyze all check files in the directconnect directory
...
- Convert directconnect_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..directconnect_service import DirectconnectService
