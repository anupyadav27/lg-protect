...
- I'm working on the **kms** service

**Current Service Details:**
- **Service Name:** kms
- **Service File:** kms_service.py
- **Check Files:** 
  - kms_cmk_are_used
...
- Read and analyze the current kms_service.py file
- Read and analyze all check files in the kms directory
...
- Convert kms_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..kms_service import KmsService
