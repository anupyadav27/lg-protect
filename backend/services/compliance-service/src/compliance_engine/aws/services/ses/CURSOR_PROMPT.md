...
- I'm working on the **ses** service

**Current Service Details:**
- **Service Name:** ses
- **Service File:** ses_service.py
- **Check Files:** 
...
- Read and analyze the current ses_service.py file
- Read and analyze all check files in the ses directory
...
- Convert ses_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..ses_service import SesService
