# Service Conversion Prompt - SECURITYHUB
...
- I'm working on the **securityhub** service

**Current Service Details:**
- **Service Name:** securityhub
- **Service File:** securityhub_service.py
- **Check Files:** 
  - securityhub_enabled
...
- Read and analyze the current securityhub_service.py file
- Read and analyze all check files in the securityhub directory
...
- Convert securityhub_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..securityhub_service import SecurityhubService
