# Service Conversion Prompt - WAFV2
...
- I'm working on the **wafv2** service

**Current Service Details:**
- **Service Name:** wafv2
- **Service File:** wafv2_service.py
- **Check Files:** 
...
- Read and analyze the current wafv2_service.py file
- Read and analyze all check files in the wafv2 directory
...
- Convert wafv2_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..wafv2_service import Wafv2Service
