# Service Conversion Prompt - INSPECTOR2
...
- I'm working on the **inspector2** service

**Current Service Details:**
- **Service Name:** inspector2
- **Service File:** inspector2_service.py
- **Check Files:** 
...
- Read and analyze the current inspector2_service.py file
- Read and analyze all check files in the inspector2 directory
...
- Convert inspector2_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..inspector2_service import Inspector2Service
