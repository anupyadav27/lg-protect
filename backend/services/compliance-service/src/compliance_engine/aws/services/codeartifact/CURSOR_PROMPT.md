# Service Conversion Prompt - CODEARTIFACT
...
- I'm working on the **codeartifact** service

**Current Service Details:**
- **Service Name:** codeartifact
- **Service File:** codeartifact_service.py
- **Check Files:** 
...
- Read and analyze the current codeartifact_service.py file
- Read and analyze all check files in the codeartifact directory
...
- Convert codeartifact_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..codeartifact_service import CodeartifactService
