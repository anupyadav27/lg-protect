# Service Conversion Prompt - ROUTE53
...
- I'm working on the **route53** service

**Current Service Details:**
- **Service Name:** route53
- **Service File:** route53_service.py
- **Check Files:** 
...
- Read and analyze the current route53_service.py file
- Read and analyze all check files in the route53 directory
...
- Convert route53_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..route53_service import Route53Service
