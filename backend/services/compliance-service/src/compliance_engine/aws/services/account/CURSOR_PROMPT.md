# Service Conversion Prompt - ACCOUNT
...
- I'm working on the **account** service

**Current Service Details:**
- **Service Name:** account
- **Service File:** account_service.py
- **Check Files:** 
...
- Read and analyze the current account_service.py file
- Read and analyze all check files in the account directory
...
- Convert account_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..account_service import AccountService
