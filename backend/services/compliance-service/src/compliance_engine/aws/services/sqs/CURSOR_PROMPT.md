...
- I'm working on the **sqs** service

**Current Service Details:**
- **Service Name:** sqs
- **Service File:** sqs_service.py
- **Check Files:** 
...
- Read and analyze the current sqs_service.py file
- Read and analyze all check files in the sqs directory
...
- Convert sqs_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..sqs_service import SqsService
