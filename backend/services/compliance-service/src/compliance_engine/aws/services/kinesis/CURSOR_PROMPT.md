# Service Conversion Prompt - KINESIS
...
- I'm working on the **kinesis** service

**Current Service Details:**
- **Service Name:** kinesis
- **Service File:** kinesis_service.py
- **Check Files:** 
...
- Read and analyze the current kinesis_service.py file
- Read and analyze all check files in the kinesis directory
...
- Convert kinesis_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..kinesis_service import KinesisService
