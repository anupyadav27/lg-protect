...
- I'm working on the **mq** service

**Current Service Details:**
- **Service Name:** mq
- **Service File:** mq_service.py
- **Check Files:** 
...
- Read and analyze the current mq_service.py file
- Read and analyze all check files in the mq directory
...
- Convert mq_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..mq_service import MqService
