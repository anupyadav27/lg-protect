# Service Conversion Prompt - WORKSPACES
...
- I'm working on the **workspaces** service

**Current Service Details:**
- **Service Name:** workspaces
- **Service File:** workspaces_service.py
- **Check Files:** 
...
- Read and analyze the current workspaces_service.py file
- Read and analyze all check files in the workspaces directory
...
- Convert workspaces_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..workspaces_service import WorkspacesService
