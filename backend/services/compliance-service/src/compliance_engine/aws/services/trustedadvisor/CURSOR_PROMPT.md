# Service Conversion Prompt - TRUSTEDADVISOR
...
- I'm working on the **trustedadvisor** service

**Current Service Details:**
- **Service Name:** trustedadvisor
- **Service File:** trustedadvisor_service.py
- **Check Files:** 
...
- Read and analyze the current trustedadvisor_service.py file
- Read and analyze all check files in the trustedadvisor directory
...
- Convert trustedadvisor_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..trustedadvisor_service import TrustedadvisorService
