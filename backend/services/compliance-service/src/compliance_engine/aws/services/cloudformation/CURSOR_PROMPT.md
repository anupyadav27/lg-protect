# Service Conversion Prompt - CLOUDFORMATION
...
- I'm working on the **cloudformation** service

**Current Service Details:**
- **Service Name:** cloudformation
- **Service File:** cloudformation_service.py
- **Check Files:** 
...
- Read and analyze the current cloudformation_service.py file
- Read and analyze all check files in the cloudformation directory
...
- Convert cloudformation_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..cloudformation_service import CloudformationService
