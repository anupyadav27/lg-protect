# Service Conversion Prompt - DOCUMENTDB
...
- I'm working on the **documentdb** service

**Current Service Details:**
- **Service Name:** documentdb
- **Service File:** documentdb_service.py
- **Check Files:** 
...
- Read and analyze the current documentdb_service.py file
- Read and analyze all check files in the documentdb directory
...
- Convert documentdb_service.py from prowler to BaseService pattern
...
- Import the corresponding service: from ..documentdb_service import DocumentdbService
